...
describe('formatDate plugin', function () {
    ...
    it('should convert dates to strings without format', function () {
        ...
        assert.equal(plugins.formatDate(moment.utc(new Date(dateString))), '2018-01-01T00:00:00Z');
        assert.equal(plugins.formatDate(moment.utc(dateString)), '2018-01-01T00:00:00Z');
        assert.equal(plugins.formatDate(moment.utc(dateString)), '2018-01-01T00:00:00Z');
    });
